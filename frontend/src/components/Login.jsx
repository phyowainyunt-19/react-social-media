...
const Login = () => {
  ...
  const responseGoogle = (response) => {
    ...
    const { name, googleId, imageUrl } = response.profileObj; // create new sanity doc for user and save these
    ...
    // create new document if not already exists in db
    ...
    <div className="flex flex-col items-center justify-start h-screen">
      <div className="relative object-cover w-full h-full">
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 flex flex-col items-center justify-center bg-blackOverlay">
          ...
          <div className="shadow-2xl top-2">
            <GoogleLogin
